		...
		<Body style={main}>
			...
			<Container style={container}>
				...
				<Section style={section}>
					...
					<Text style={text}>
						Last week, we kicked things off with round shapes. We up the Pens
						from week one in our{' '}
					...
					<Text style={text}>
						This idea for your Pen. As always, the template is just as jumping
						off point. Feel free to incorporate the 🧊 in your creation, add
						more elements, or freeze it out completely and start over from
						scratch!
					</Text>
				...
				<Text style={yellowSection}>
					...
					l be watching and gathering the Pens into a Collection, and sharing on{' '}
						...
						<Column style={resources}>
							...
							<Section style={blueCard}>
								...
								<Text style={textCard}>
									...
									EntropyReverseds{' '}
									<Link style={blueLink}>Pulsating Tesseract</Link>, Josetxs{' '}
							...
							<Section style={blueCard}>
								...
								<Text style={textCard}>
									...
									Ryan Mulligans <Link style={blueLink}>Cube Sphere</Link>,
									Munir Safis{' '}
									<Link style={blueLink}>
